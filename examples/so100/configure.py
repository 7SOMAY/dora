"""SO100 Configuration Tool: This program is used to automatically configure the SO100 robot.
...
def configure_servos(bus: FeetechBus):
    """Configure the Feetech servos with appropriate parameters.

    Args:
        bus: A FeetechBus instance for communicating with the servos.
