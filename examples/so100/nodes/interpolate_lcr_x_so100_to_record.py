"""Node for recording interpolated joint positions from LCR and SO100.

This node handles the recording of interpolated joint positions
from both LCR and SO100 robots for later playback.
"""
...
def main():
    """Main function to run the LCR and SO100 recording node."""
