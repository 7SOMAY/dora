"""Node for interpolating joint positions from LCR to SO100 format.

This node handles the conversion and interpolation of joint positions
from the LCR robot format to the SO100 robot format.
"""
...
def main():
    """Main function to run the LCR to SO100 interpolation node."""
